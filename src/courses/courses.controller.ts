...
import { mapLectureDbRecordToLecture } from './utils/map-lecture-db-record-to-lecture.util';
...
import { UploadLectureFileResponse } from './types/result-of-upload-a-lecture-file.type';
